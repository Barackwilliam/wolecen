...
class User(AbstractUser):
    ...
    # ── Permission properties (also @property for template consistency) ──
    @property
    ...
    def get_og_image_url(self):
        if self.avatar:
            return f"https://ucarecdn.com/{self.avatar}/-/resize/1200x630/-/format/auto/"
        return ""

    # Optimized image for normal website usage
    def get_image_url(self):
        if self.avatar:
            return f"https://ucarecdn.com/{self.avatar}/-/format/jpg/-/quality/smart/"
        return ""
